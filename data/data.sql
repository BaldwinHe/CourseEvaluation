CREATE TABLE `collect` (
  ...
  `movie` varchar(4095) CHARACTER SET utf8 DEFAULT NULL,
  `comment` varchar(4095) CHARACTER SET utf8 DEFAULT NULL,
...
SET @IMAGE_BASE_URL = "	https://movie-1257919653.cos.ap-shanghai.myqcloud.com/"; -- FOR EXAMPLE: https://*****.ap-shanghai.myqcloud.com/
